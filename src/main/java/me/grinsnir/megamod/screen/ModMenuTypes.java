package me.grinsnir.megamod.screen;
...
public class ModMenuTypes {
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(Registries.MENU, MegaMod.MOD_ID);

    public static final DeferredHolder<MenuType<?>, MenuType<SteeringWheelMenu>> STEERING_WHEEL_MENU =
            registerMenuType("steering_wheel_menu", SteeringWheelMenu::new);
